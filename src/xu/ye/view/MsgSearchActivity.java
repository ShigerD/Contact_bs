...
public class MsgSearchActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_search.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				{
					msgs.clear();
					List list=queryMemberInName(et_search.getText().toString());
					List listCon=queryMemberInCon(et_search.getText().toString());
	...
	private List queryMemberInCon(String body1){
	...
	private List queryMemberInName(String body1){
	   ...
	   Cursor cursor=getContentResolver().query(uri, projection, "address like'%"+body1+"%'", null, "date asc");
