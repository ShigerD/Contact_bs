...
public class ContactSearchActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_search.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				contacts.clear();
				ContactBean cbnum = queryMemberInNumber(et_search.getText().toString());
				ContactBean cbname = queryMemberInName(et_search.getText().toString());
	...
	private ContactBean queryMemberInNumber(String name1){
	...
	//	Cursor cursor = getContentResolver().query(uri, projection, ContactsContract.CommonDataKinds.Phone.NUMBER + " like '%" + name1+"%'", null, null);
		Cursor cursor = getContentResolver().query(uri, projection, ContactsContract.CommonDataKinds.Phone.NUMBER + " like '%" + name1+"%'", null, null);
...
//				}
	...
	private ContactBean queryMemberInName(String name1){
