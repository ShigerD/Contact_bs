...
//		callLogList.addFooterView(tv);
	...
	@OnLongClick({R.id.dialNum0,R.id.dialNum1,R.id.dialNum2,R.id.dialNum3,R.id.dialNum4,R.id.dialNum5
		,R.id.dialNum6,R.id.dialNum7,R.id.dialNum8,R.id.dialNum9})
	public boolean onLongClick(View v) {
		// TODO Auto-generated method stub
		int number=0;
		switch (v.getId()) {
				...
				for (int i = 0; i < kuaiXus.size(); i++) {
					if (kuaiXus.get(i).getNumber()==number) {
						Intent intent = new Intent(Intent.ACTION_CALL, Uri
								.parse("tel:" + kuaiXus.get(i).getPhone()));
